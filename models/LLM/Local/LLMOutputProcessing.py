...
for i in range(151):    
    data = pd.read_json(f'/code//Daten/LLMEval/Local/ThirdTry/eval{i}.jsonl', lines=True)
...
with open(f'/code//Daten/LLMEval/Local/ThirdTry/evalList.jsonl', 'w', encoding='utf-8') as file:
  for each in ListOfJsons:
       file.write(each + '\n')
