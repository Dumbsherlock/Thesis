...
data = pd.read_json(path_or_buf="/code//Daten/LLMEval/API/SecondTry/AnnotedEvalSamples/evalAnno.jsonl", lines=True)
...
evaluator = Evaluator(predicitons, truths, tags=["Krankheit"])
